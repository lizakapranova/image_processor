...
## Запуск программы
Скомпилированный файл находится в папке `cmake-build-release`, программу следует запускать из нее. Нужно указывать абсолютный путь к изображениям. 
Примеры обработанных изображений находятся в папке `examples` 
...
Если фильтр задан матрицей, это означает, что значение каждого из цветов определяется средневзвешенным
